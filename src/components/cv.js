            ...
            <div id="cv" className="cv">
                ...
                <header className="heading">
                    <svg
                        ...
                        <Link to="/">
                            <g
                                transform="translate(360 180) rotate(180)"
                                fill="#a6a6a6">
                ...
                <main>
                    <article>
                        ...
                        <section>
                            <p>
                                I began learning to code with some downtime
                        ...
                        <section className="experience">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>
                                        This role taught me a ton about real
                                        world development. It set me on the path
                                        to building the self discipline I have
                                        now and has reassured me I'm headed in
                                        the right direction.
                                    </p>
                                </li>
                                <li>
                                    ...
                                    <p>
                                        In this role I evaluate solo project
                                        submissions. I've also played a part in
                                        planning, designing, and developing
                                        projects for fellow Chingus to base
                                        their solo projects on.
                                    </p>
                                </li>
                                <li>
                                    ...
                                    <p>
                                        I've worked in several teams so far on
                                        these 6 week agile developer projects.
                                        Each time I've gained a treasure trove
                                        of insight about my strengths and
                                        weaknesses. One of the most valuable
                                        lessons I've learned from them is how
                                        integral planning is.
                                    </p>
                                </li>
                            </ul>
                        </section>
